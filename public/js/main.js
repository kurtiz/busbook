!function () {
    ...
    window.App = {}, App.html = document.querySelector("html"), App.body = document.querySelector("body"), App.SMcontroller = new ScrollMagic.Controller, window.onload = function () {
        document.fonts.ready.then(function () {
            !function () {
            ...
            }(), document.querySelector(".js-lazy") && new LazyLoad({elements_selector: ".js-lazy"}), t.init(), n.init(), function () {
                const e = document.querySelectorAll(".js-section-slider");
                if (e.length) for (let t = 0; t < e.length; t++) {
                    const n = e[t];
                    let s = n.querySelector(".js-prev"), i = n.querySelector(".js-next");
            ...
            }), r.init(), r.ddInit(), l.init(), l.headerSticky(), function () {
                ...
                e && e.forEach(e => {
                    const t = e.getAttribute("data-el-toggle"), n = document.querySelector(t),
                        s = e.getAttribute("data-el-toggle-active"), i = document.querySelector(s);
                ...
                e && e.forEach(e => {
                    const n = e.querySelectorAll(".table-calendar__grid > *"), s = e.querySelector(".js-first-date"),
                ...
                if (document.querySelector(".js-testimonials-slider-3")) {
                    const t = document.querySelector(".js-testimonials-slider-pag"), n = t.querySelector(".js-current"),
                ...
                navigation: {prevEl: ".js-calendar-prev", nextEl: ".js-calendar-next"}
            }), new Swiper(".js-masthead-slider-9", {
                speed: 600,
                loop: !0,
                lazy: {loadPrevNext: !0},
                navigation: {prevEl: ".js-prev", nextEl: ".js-next"}
            }), GLightbox({selector: ".js-gallery", touchNavigation: !0, loop: !1, autoplayVideos: !0}), function () {
                ...
                e && e.forEach(e => {
                    ...
                    const n = e.offsetHeight + parseInt(t),
                        s = e.querySelector(".js-pin-content").offsetHeight + parseInt(t), i = new ScrollMagic.Scene({
                            duration: n - s,
                            offset: s,
                            triggerElement: e,
                            triggerHook: "onEnter"
                ...
                const t = e, n = e.querySelectorAll(".js-mouse-move");
                n.forEach(e => {
                    const n = e.getAttribute("data-move");
                    document.addEventListener("mousemove", s => {
                        const i = s.pageX - t.offsetLeft, r = s.pageY - t.offsetTop;
                        gsap.to(e, {
                ...
                e && e.forEach(e => {
                    ...
                    t.forEach(t => {
                        const n = t.querySelector(".js-count"), s = t.querySelector(".js-down"),
                ...
                if (!e) return;
                const t = [{city: "London", country: "Greater London, United Kingdom"}, {
                    city: "New York",
                ...
                }), n = [{lat: 40.80061, lng: -74.035242}, {lat: 40.73061, lng: -73.935242}, {
                    lat: 40.74061,
                    lng: -73.825242
                }, {lat: 40.70061, lng: -73.885242}, {lat: 40.67061, lng: -73.785242}, {
                    lat: 40.68061,
                    lng: -73.905242
                }].map(n => {
                    const s = new e({
                ...
                const t = new google.maps.Map(document.querySelector(".js-map-places"), {
                    zoom: 10,
                    center: {lat: 40.8, lng: -74.02}
                }), n = [{lat: 40.80061, lng: -74.035242}, {lat: 41.00061, lng: -74.135242}, {
                    lat: 40.70061,
                    lng: -73.835242
                }].map(n => {
                    const s = new e({
    ...
    const t = function () {
        ...
        function e(e) {
            ...
            (t = e.getAttribute("data-anim") ? e.getAttribute("data-anim") : e.getAttribute("data-anim-child")).includes("delay-") && (n = (s = t.split(" ").pop()).substr(s.indexOf("-") + 1) / 10), t.includes("counter") ? function (e, t = 0) {
                const n = e.getAttribute("data-counter"), s = e.getAttribute("data-counter-add"), i = t;
                let r = "", l = {count: 0};
                const o = e.querySelector(".js-counter-num");
                s && (r = s);
                gsap.to(l, {
                    count: n, delay: i, duration: 1.8, ease: "power3.inOut", onUpdate: function () {
                        o.innerHTML = Math.round(l.count) + r
                    }
                })
            }(e, n) : t.includes("line-chart") ? function (e, t = 0) {
                const n = e.getAttribute("data-percent");
                gsap.fromTo(e.querySelector(".js-bar"), {scaleX: 0}, {
                    delay: .45 + t,
                    duration: 1,
                    ease: "power3.inOut",
                    scaleX: n / 100
                ...
                gsap.to(s, {
                    count: n, delay: .45 + t, duration: 1, ease: "power3.inOut", onUpdate: function () {
                        i.innerHTML = Math.round(s.count)
                    }
                })
            }(e, n) : t.includes("pie-chart") ? function (e, t = 0) {
                const n = e.getAttribute("data-percent"), s = e.querySelector(".js-chart-bar");
                n < 0 && (n = 0);
                n > 100 && (n = 100);
                gsap.fromTo(s, {drawSVG: "0%"}, {
                    delay: .3 + t,
                    duration: 1.4,
                    ease: "power3.inOut",
                    drawSVG: `${n}%`,
        ...
        return {
            init: function () {
                !function () {
                    ...
                    if (t.length) for (let n = 0; n < t.length; n++) {
                        const s = t[n];
        ...
        return {
            init: function (t) {
                document.querySelectorAll(t).forEach(t => (function (t) {
                    const n = t.querySelector(".js-button"), s = n.querySelector(".js-button-title");
                    t.classList.contains("js-liveSearch") && function (e) {
                        const t = e.querySelector(".js-search"), n = e.querySelectorAll(".js-options > *");
    ...
    const r = function () {
        function e() {
            ...
            t && t.forEach(e => {
                ...
                e.querySelector("[data-x-dd-click]").getAttribute("data-x-dd-click").split(", ").forEach(e => {
                    ...
                    const n = document.querySelector(`[data-x-dd=${e}]`), s = n.getAttribute("data-x-dd-toggle");
            ...
            ddInit: function () {
                ...
                t && t.forEach(t => {
                    ...
                    n.getAttribute("data-x-dd-click").split(", ").forEach(s => {
                        const i = t.querySelector(`[data-x-dd=${s}]`), r = i.getAttribute("data-x-dd-toggle");
                        n.addEventListener("click", () => {
        ...
        function r(e, n, r) {
            ...
            ((window.innerWidth > 0 ? window.innerWidth : screen.width) < 1199 || document.querySelector(".js-desktopMenu")) && (s.clear(), i(r) || gsap.to(t, {
                ...
                ease: "quart.out", stagger: -.04, duration: .8, y: "100%", onStart: () => {
                ...
                y: "0px",
                opacity: 1
            }, ">-0.5"), s.to(a, {ease: "quart.out", stagger: .08, duration: .9, y: "0%"}, ">-0.6"))
        }
        ...
        return {
            headerSticky: function () {
                ...
                if (!e) return;
                let t = "";
                e.getAttribute("data-add-bg") && (t = e.getAttribute("data-add-bg")), new ScrollMagic.Scene({offset: "6px"}).setClassToggle(e, t).addTo(App.SMcontroller), new ScrollMagic.Scene({offset: "6px"}).setClassToggle(e, "is-sticky").addTo(App.SMcontroller)
            }, init: function () {
                e = document.querySelector(".js-navList"), t = document.querySelectorAll(".js-nav-list-back"), n = 0, function () {
                    const s = document.querySelectorAll(".js-navList .menu-item-has-children");
                    s.length && (t.forEach(t => {
                        t.addEventListener("click", () => {
                            const t = e.querySelector("ul.-is-active"), s = t.parentElement.parentElement;
                        ...
                        t.removeAttribute("href"), t.addEventListener("click", () => {
                            const s = e.parentElement, i = e.lastElementChild;
                            r(s, i, ++n, t.innerHTML)
                        })
                    }))
                }()
